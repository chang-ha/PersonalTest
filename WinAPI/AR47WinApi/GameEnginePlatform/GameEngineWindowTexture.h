...
public:
	...
	// 내가 띄울 이미지를 확대하거나, 특정 색상을 띄우지 않게 하기 위해 사용 (기본값은 RGB(255, 255, 255)로 하였음 << 흰색)
...
private:
	...
	BITMAP Info = {}; // 해당 Texture의 크기를 저장하는 멤버변수
	void ScaleCheck(); // 해당 Texture의 크기를 알아내어서 Info에 저장하는 함수 
};
